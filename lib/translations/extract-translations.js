...
function conceptTranslationValues(row, lang, concepts) {
...
module.exports = async function extractTranslations(concepts, document) {
      ...
      LANG.forEach(lang => {
        switch (sheet.title) {
          ...
          case 'Concepts-Values':
            ...
            _.set(translations, [lang, 'concept', row.concept], conceptTranslationValues(row, lang, concepts));
            break;
          case 'Application':
